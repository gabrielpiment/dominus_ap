...
│   ├── components/   # componentes de UI (pequenos, reutilizáveis, sem lógica de dados)
...
- **Páginas (`/app/pages`)** — **minúsculas sem traços**, usar apenas letras e, se necessário, subpastas  
